...
public class OfferServiceTest {
	...
	public void shouldGenerateAndStoreAnOfferForUser() {
		given(offerFactory.createFor(DUMMY_BASKET_DETAILS, DUMMY_DELIVERY_METHOD_ID, DUMMY_PAYMENT_METHOD_ID)).willReturn(DUMMY_OFFER);

		OfferDetails offerDetails = offerService.generateOfferFor(DUMMY_BASKET_DETAILS, DUMMY_DELIVERY_METHOD_ID, DUMMY_PAYMENT_METHOD_ID);
	...
	public void shouldAllowAcceptanceOfGeneratedOffer() {
		Offer offer = new Offer(DUMMY_USER_ID, ImmutableSet.of(DUMMY_PRODUCT), DUMMY_DELIVERY_METHOD_ID, DUMMY_PAYMENT_METHOD_ID);
